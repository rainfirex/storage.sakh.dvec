                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.username)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.login)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.email)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.department)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.title)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.phone)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.mobile)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.othertelephone)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.city)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.street)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.cabinet)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.operatingsystem)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.servicepack)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.ipAddress)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" title="Скопировать" @click.prevent="copyFieldBuffer($refs.hostname)"><i class="fa fa-files-o" aria-hidden="true"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        computed:{
            ...
            user_id() { return this.$route.params.id;}
        },
        mounted() {
        ...
        methods: {
            ...
            getEntityUser(){
                ...
                const url = `/api/entity/users/${this.user_id}`;
                axios.get(url)
                    .then(response => {
                        this.user = response.data.user;
                        this.passwords = response.data.user.passwords;
                    })
                    .catch(e => {
            ...
            removeComputer(){
                ...
                if (index !== -1){
                    ...
                    if (this.selectComp.hasOwnProperty('id')) {

                        const url = `/api/entity/computers/${ this.selectComp.id}`;
            ...
            save() {
                ...
                frmData.append('passwords', JSON.stringify(this.user.passwords));
                ...
                axios.post(url, frmData)
                    .then(response => {
                        if (response.data.success){
                            this.setMessenger({text: 'Запись обновлена.', status: 'success'});
                            this.resetData();
                        } else {
            ...
            resetData(){
                ...
                this.$router.push({name: 'entity.users'});
            }
        }
    }
</script>
